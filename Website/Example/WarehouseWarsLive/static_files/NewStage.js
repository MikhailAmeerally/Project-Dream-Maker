...
class NewStage {
    ...
    _generateMonsters(monsterCount) {
        ...
        for (var numMon = 0; numMon < monsterCount; numMon++) {
            ...
            this.monsters.push(this._gameSpace[randX][randY]);
    ...
    _generateBoxes() {
        var maxBoxCount = (Math.ceil((this._width - 2) * (this._height - 2)) * 0.3) - 1;
    ...
    getFreeSpace() {
        ...
        while(0 == "0") {
            ...
            var randX = Math.floor(Math.random() * (this._width - 2)) + 1;
            var randY = Math.floor(Math.random() * (this._height - 2)) + 1;

            if (this._gameSpace[randX][randY].getType() == "blank") {
                coordinates.x = randX;
                coordinates.y = randY;
                return coordinates;
            }
